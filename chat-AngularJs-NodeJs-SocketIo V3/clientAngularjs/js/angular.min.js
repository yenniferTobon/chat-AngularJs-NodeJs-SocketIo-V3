...
(function (Q, X, w) {
        ...
        if (a) {
            ...
            if (J(b))
                ...
                if (mc(b)) for (e in b) a[e] = ha(b[e], null, c, d);
                    ...
                    for (e in b)
                        b.hasOwnProperty(e) && (a[e] = ha(b[e], null, c, d));
                else
    ...
    function ub(b, a) {
        ...
        if (b.querySelectorAll)
            for (
                var c = b.querySelectorAll('*'), d = 0, e = c.length;
                d < e;
                d++
            )
                vb(c[d]);
    ...
    function vb(b, a) {
        ...
        d &&
            (a
                ? delete d.data[a]
                : (d.handle &&
                      (d.events.$destroy && d.handle({}, '$destroy'), Oc(b)),
                  delete hb[c],
                  (b.ng339 = w)));
    }
    function wb(b, a) {
        ...
        function g(b, c) {
            ...
            return {
                ...
                instantiate: function (a, b, c) {
                    var d = Object.create(
                        (J(a) ? a[a.length - 1] : a).prototype || null
                    );
                    a = e(a, d, b, c);
                    return C(a) || x(a) ? a : d;
                },
                ...
                has: function (a) {
                    return (
                        p.hasOwnProperty(a + 'Provider') || b.hasOwnProperty(a)
                    );
                }
            };
        }
                ...
                function D(a, b, d, e, f, g, h, k, r) {
                    ...
                    function O(a, b, c, d, e, f) {
                        ...
                        for (h in d) {
                            ...
                            g[k.name] = l;
                            ia ||
                                a.data('$' + k.name + 'Controller', l.instance);
                        }
                        return g;
                    }
                        ...
                        for (l = h.length; n < l; n++)
                            (q = h[n]),
                                aa(
                                    ...
                                    f,
                                    q.require &&
                                        t(q.directiveName, q.require, N, ca),
                                    z
                                );
                        var za = c;
                        ...
                        if (D.templateUrl)
                            ...
                            try {
                                (na = D.compile(v, d, Ka)),
                                    x(na)
                                        ? n(null, na, P, R)
                                        : na && n(na.pre, na.post, P, R);
                            } catch (V) {
                                c(V, xa(v));
                            }
                        D.terminal &&
                            ((K.terminal = !0), (H = Math.max(H, D.priority)));
                    }
                    K.scope = S && !0 === S.scope;
                ...
                function Mf(a, b, c, e, f, g, h, k) {
                    ...
                    return function (a, b, c, d, e) {
                        ...
                        b.$$destroyed ||
                            (l
                                ? l.push(b, c, d, a)
                                : (r.transcludeOnThisElement &&
                                      (a = ba(b, r.transclude, e)),
                                  r(n, b, c, d, a, r)));
                    };
                }
                function M(a, b) {
        ...
        this.$get = [
            ...
            function (e, f, h, g, l, k) {
                ...
                function p(c, d) {
                    ...
                    v(m) &&
                        ((m = fd(c.url)
                            ? f()[c.xsrfCookieName || b.xsrfCookieName]
                            : w) &&
        ...
        return function (e, g, l, k, n, p, r, t) {
            ...
            if ('jsonp' == F(e)) {
                ...
                z.onload = function () {
                    ...
                    0 === c &&
                        (c = b ? 200 : 'file' == Aa(g).protocol ? 404 : 0);
    ...
    function U(b, a) {
        ...
        switch (b.type) {
            ...
            case s.MemberExpression:
                ...
                b.constant =
                    b.object.constant && (!b.computed || b.property.constant);
                b.toWatch = [b];
                break;
    ...
    var J = Array.isArray,
        ...
        Fa = function () {
            if (!A(Fa.rules)) {
                var b =
                    X.querySelector('[ng-csp]') ||
                    X.querySelector('[data-ng-csp]');
                if (b) {
                    var a =
                        b.getAttribute('ng-csp') ||
                        b.getAttribute('data-ng-csp');
                    Fa.rules = {
    ...
    var Sc = {};
    m('input select option textarea button form details'.split(' '), function (
        b
    ) {
        Sc[b] = !0;
    });
    ...
    m(
        {
            ...
            isolateScope: function (b) {
                return (
                    B.data(b, '$isolateScope') ||
                    B.data(b, '$isolateScopeNoTemplate')
                );
            },
            controller: Pc,
            injector: function (b) {
                ...
                if (d !== Pa && 2 !== d && 8 !== d)
                    if (((d = F(a)), Bb[d]))
                        if (A(c))
                            ...
                            return b[a] ||
                                (b.attributes.getNamedItem(a) || y).specified
                                ? d
                                : w;
                ...
                function (a, c) {
                    ...
                    return function (c, f) {
                        function h() {
                            a(function () {
                                f.addClass &&
                                    (c.addClass(f.addClass),
                                    (f.addClass = null));
                                f.removeClass &&
                                    (c.removeClass(f.removeClass),
                                    (f.removeClass = null));
        ...
        $e = function () {
            this.$get = [
                ...
                function (a) {
                    return function (c) {
                        c
                            ? !c.nodeType && c instanceof B && (c = c[0])
                            : (c = a[0].body);
            ...
            switch (a.type) {
                ...
                case s.MemberExpression:
                    return (
                        ...
                        a.computed ||
                            (Xa(a.property.name, h.expression),
                            (f = a.property.name)),
                            ...
                            : function (a, d, e, p) {
                                  ...
                                  if (null != r.value) {
                                      ...
                                      for (var s = 0; s < g.length; ++s)
                                          m.push(
                                              Ba(g[s](a, d, e, p), h.expression)
                                          );
                                      m = Ba(
                                          r.value.apply(r.context, m),
                                          h.expression
                                      );
                                  }
                                  return c ? { value: m } : m;
        ...
        xg = [
            ...
            function (a, c, d, e, f, h, g, l, k, n) {
                ...
                this.$$parseAndValidate = function () {
                    ...
                    q.$$runValidators(c, q.$$lastCommittedViewValue, function (
                        a
                    ) {
                        f ||
                            ((q.$modelValue = a ? c : w),
                ...
                return {
                    ...
                    link: function (c, g, l, k) {
                        ...
                        if (w) {
                            ...
                            k = l.multiple;
                            for (
                                var q, z = 0, y = g.children(), A = y.length;
                                z < A;
                                z++
                            )
                                if ('' === y[z].value) {
